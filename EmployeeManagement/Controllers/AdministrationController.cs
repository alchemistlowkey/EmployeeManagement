    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> ManageUserClaims(string userId)
        {
            ...
            foreach (Claim claim in ClaimsStore.AllClaims)
            {
                ...
                // next to the claim is checked on page load
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                {
                    logger.LogError(exception, $"Error deleting role {role.Name}");

                    ViewBag.ErrorTitle = $"{role.Name} role is in use";
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted as there are users in this role. If you want to delete this role, please remove the users from the role and then try to delete it.";
                    return View("Error");
                }
            }
        }
